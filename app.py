...
def search_artists():
  ...
  result_artists = Artist.query.filter(Artist.name.ilike("%" + searched_term + "%")).all()
...
def show_artist(artist_id):
  ...
  count_upcoming_shows = Show.query.filter(Show.artist_id == artist_id,Show.start_time > datetime.utcnow()).count()
